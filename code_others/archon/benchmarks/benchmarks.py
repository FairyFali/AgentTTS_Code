...
BENCHMARK_CLASSES = {
    "alpaca_eval": AlpacaEvalBenchmark, # 805
    "mt_bench": MtBenchBenchmark,
    "arena_hard_auto": ArenaHardAutoBenchmark, # 500
    "mix_eval": MixEvalBenchmark, # 4000
    "mix_eval_hard": MixEvalHardBenchmark, # 1000
    "code_contests": CodeContestsBenchmark, #
    "gsm8k": GSM8KBenchmark, # 1319
    "human_eval": HumanEvalBenchmark, #
    "mbpp": MBPPBenchmark,
    "math": MATHBenchmark,
    "minif2f": MiniF2FBenchmark, # 244
    "mmlu": MMLUBenchmark, # 378
}
