...
class RolePlaying:
    ...
    def __init__(
        ...
        self.assistant_agent: ChatAgent = ChatAgent(self.assistant_sys_msg, memory, model_type, repeating, **(assistant_agent_kwargs or {}), )
        self.user_agent: ChatAgent = ChatAgent(self.user_sys_msg, memory, model_type, repeating, **(user_agent_kwargs or {}), )
    ...
    def init_chat(self, phase_type: PhaseType = None,
        ...
        # here we concatenate to store the real message in the
        if print_log:
