...
'''\n""" + unified_diff + "\n```"
                ...
                if print_log: log_visualize(update_codes_content)
        ...
        if git_management:
            ...
            if self.version == 1.0:
                ...
                log_git_info += "cd {}; git submodule add ./{} {}\n".format(
                    ...
                    "WareHouse/" + os.path.basename(self.directory),
                    "WareHouse/" + os.path.basename(self.directory))
                if print_log: log_visualize(rewrite_codes_content)
        ...
        for root, directories, filenames in os.walk(directory):
            for filename in filenames:
                if filename.endswith(".py"):
                    ...
                    self.codebooks[filename] = self._format_code(code)
        if print_log: log_visualize("{} files read from {}".format(len(self.codebooks.keys()), directory))
