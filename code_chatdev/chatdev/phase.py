...
class Phase(ABC):
    ...
    def __init__(self,
        ...
        self.max_retries = 3  # max retries is 3
        self.reflection_prompt = """Here is a conversation between two roles: {conversations} {question}"""
        self.model_type = model_type
        self.repeating = repeating
        self.log_filepath = log_filepath
        # print('phase', phase_name, f'with role {user_role_name} is using model', self.model_type, 'repeating', self.repeating)
    ...
    def chatting(
        ...
        if print_log: print('Log, turns of chatting:', i+1)
